...
class Single_Post_Template_Plugin {
	...
	function add_metabox() {
		...
		if ( $this->get_post_templates() )
			add_meta_box( 'pt_post_templates', __( 'Template do post', 'genesis' ), array( $this, 'metabox' ), 'post', 'normal', 'high' );
	...
	function metabox( $post ) {
		...
		<label class="hidden" for="post_template">Tema do post</label><br />
